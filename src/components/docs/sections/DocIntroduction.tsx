    ...
    <article className="space-y-14 animate-fade-in text-[#A1A1A1]">
      ...
      <section className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-[16px] font-semibold text-[#FAFAFA] tracking-[-0.01em]">Quick Installation</h2>
        </div>
        <p className="text-[14px] text-[#A1A1A1] leading-relaxed">
          Add any component directly to your project using the shadcn CLI. The code is placed straight into your <code className="text-[#FAFAFA] font-mono bg-[#0E0E0E] border border-[#1F1F1F] px-1.5 py-0.5 rounded text-[12px]">components/ui/</code> folder.
        </p>
        <DocCodeBlock
      ...
      <section className="space-y-5">
        <div className="space-y-1.5">
          ...
          <h2 className="text-[16px] font-semibold text-[#FAFAFA] tracking-[-0.01em]">Design Philosophy</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-5 rounded-lg border border-[#1F1F1F] bg-[#0B0B0B]">
            <div className="w-8 h-8 rounded-md bg-[#141414] border border-[#1F1F1F] flex items-center justify-center mb-3">
              <Code2 className="w-4 h-4 text-[#FAFAFA]" />
            </div>
            <h3 className="text-[14px] font-semibold text-[#FAFAFA] mb-1.5">Source Ownership</h3>
          ...
          <div className="p-5 rounded-lg border border-[#1F1F1F] bg-[#0B0B0B]">
            ...
            <h3 className="text-[14px] font-semibold text-[#FAFAFA] mb-1.5">Spring Physics</h3>
            <p className="text-[13px] text-[#A1A1A1] leading-relaxed">
          ...
          <div className="p-5 rounded-lg border border-[#1F1F1F] bg-[#0B0B0B]">
            ...
            <h3 className="text-[14px] font-semibold text-[#FAFAFA] mb-1.5">Auto-Synced Registry</h3>
            <p className="text-[13px] text-[#A1A1A1] leading-relaxed">
          ...
          <div className="p-5 rounded-lg border border-[#1F1F1F] bg-[#0B0B0B]">
            ...
            <h3 className="text-[14px] font-semibold text-[#FAFAFA] mb-1.5">Accessible & Type-Safe</h3>
            <p className="text-[13px] text-[#A1A1A1] leading-relaxed">
              Full TypeScript prop types, keyboard accessibility, ARIA standards, and automatic <code className="text-[#FAFAFA] font-mono bg-[#0E0E0E] border border-[#1F1F1F] px-1 rounded text-[12px]">prefers-reduced-motion</code> support.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Tech Stack Callout */}
      <section className="p-4 rounded-lg border border-[#1F1F1F] bg-[#0B0B0B] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="text-[13px]">
            ...
            <p className="text-[#6B6B6B] mt-0.5 text-[12px]">Compatible with Next.js (App Router / Pages), Vite, Remix, and Astro.</p>
          </div>
        </div>
      </section>
