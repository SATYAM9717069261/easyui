  ...
  return (
    <article className="space-y-14 animate-fade-in text-[#A1A1A1]">
      ...
      <section className="p-5 rounded-lg border border-[#1F1F1F] bg-[#0B0B0B] space-y-3">
        <div className="flex items-center gap-2 text-[14px] text-[#FAFAFA] font-semibold">
        ...
        <p className="text-[13px] text-[#A1A1A1] leading-relaxed">
          When adding a component, you only ever create or touch two files in <code className="text-[#FAFAFA] font-mono bg-[#0E0E0E] border border-[#1F1F1F] px-1.5 py-0.5 rounded text-[12px]">src/components/ui/</code>:
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
          <div className="p-3.5 rounded-md border border-[#1F1F1F] bg-[#0E0E0E] text-[12.5px]">
            <span className="text-[13px] text-[#FAFAFA] font-semibold block mb-1">1. Component (.tsx)</span>
            <span className="text-[#6B6B6B]">React + Tailwind CSS + Framer Motion implementation.</span>
          </div>
          <div className="p-3.5 rounded-md border border-[#1F1F1F] bg-[#0E0E0E] text-[12.5px]">
            <span className="text-[13px] text-[#FAFAFA] font-semibold block mb-1">2. Metadata (.meta.ts)</span>
            <span className="text-[#6B6B6B]">Name, description, props documentation, and usage code.</span>
          </div>
        </div>
      ...
      <section className="space-y-4">
        ...
        <h2 className="text-[16px] font-semibold text-[#FAFAFA] tracking-[-0.01em]">Scaffold a Starter Template</h2>
        ...
        />
        <p className="text-[12px] text-[#6B6B6B]">
          This creates <code className="text-[#FAFAFA] font-mono text-[12px]">src/components/ui/TiltCard.tsx</code> and <code className="text-[#FAFAFA] font-mono text-[12px]">src/components/ui/TiltCard.meta.ts</code>.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <h2 className="text-[16px] font-semibold text-[#FAFAFA] tracking-[-0.01em]">Write the Component Code</h2>
        <p className="text-[14px] text-[#A1A1A1] leading-relaxed">
  ...
  return (
    ...
    >
      ...
      <section className="space-y-4">
        ...
        <h2 className="text-[16px] font-semibold text-[#FAFAFA] tracking-[-0.01em]">Define Component Metadata</h2>
        <p className="text-[14px] text-[#A1A1A1] leading-relaxed">
...
export const TiltCardMeta: EasyComponentMeta = {
  ...
  sourceCode: '', // Automatically populated by sync script
      ...
      <section className="space-y-4">
        ...
        <h2 className="text-[16px] font-semibold text-[#FAFAFA] tracking-[-0.01em]">Sync & Validate</h2>
        <p className="text-[14px] text-[#A1A1A1] leading-relaxed">
...
npm run registry:validate`}
      ...
      <section className="p-5 rounded-lg border border-[#1F1F1F] bg-[#0B0B0B] space-y-3">
        <div className="flex items-center gap-2">
          <GitPullRequest className="w-3.5 h-3.5 text-[#FAFAFA]" />
          <h2 className="text-[14px] font-semibold text-[#FAFAFA]">Pull Request Checklist</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[13px]">
          {[
            ...
            <div
              key={idx}
              className="flex items-start gap-2 p-2.5 rounded-md border border-[#1F1F1F] bg-[#0E0E0E]"
            >
