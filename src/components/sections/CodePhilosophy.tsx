        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="p-4 rounded-xl border border-[#1D1D1D] bg-[#0A0A0A] space-y-3.5">
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-xs text-[#A1A1A1]">
                  ...
                  <span className="font-mono text-[#38BDF8]">{strength}x</span>
                </div>
                <input
                  type="range"
                  min="0.1"
                  ...
                  className="w-full accent-[#38BDF8] bg-[#1C1C1C] h-1.5 rounded-lg cursor-pointer"
                />
              </div>
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="rounded-2xl border border-[#1E1E1E] bg-[#090909] overflow-hidden">
              ...
              <pre className="p-4 text-xs font-mono text-[#CCCCCC] overflow-x-auto leading-relaxed selection:bg-[#38BDF8]/20">
